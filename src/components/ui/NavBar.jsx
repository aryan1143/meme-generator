    ...
    return (
        <div className='flex items-center justify-between main-padding py-2 bg-gray-200 border-b border-gray-400'>
            ...
            <div className='flex items-center gap-4'>
                <Button btnText={<><FiUpload className="inline mr-2" /> Upload Image</>} isRoundedProp={true} colorProp={'bg-orange-400 hover:bg-orange-500'} sizeProp={'small'} isBoldProp={true} />
