...
function MemeCanvas({ canvasRef, imageSrc, setSharedVar, sharedVars, pos, setPos, selectedText, setSelectedText }) {
  ...
  return (
    <div ref={canvasRef} className={`touch-none flex relative h-[80vh] w-[80vh] shrink-0 bg-main overflow-hidden rounded-md border-2 border-gray-400 max-md:w-[95vw] max-md:h-[95vw]`}>
      ...
      <TextDraggable setSharedVar={setSharedVar} top={pos.text1.y} left={pos.text1.x} fontSize={sharedVars.text1.fontSize || 20} text={sharedVars.text1.text} font={sharedVars.text1.font} className={sharedVars.text1.textClassName} outline={sharedVars.text1.outline} outlineColor={sharedVars.text1.outlineColor} bold={sharedVars.text1.bold} italic={sharedVars.text1.italic} underline={sharedVars.text1.underline} isSelected={selectedText === 'text1'} selectedText={'text1'} setSelectedText={setSelectedText} sharedVar={sharedVar} setTextMousePosition={setTextMousePosition}/>
      <TextDraggable setSharedVar={setSharedVar} top={pos.text2.y} left={pos.text2.x} fontSize={sharedVars.text2.fontSize || 20} text={sharedVars.text2.text} font={sharedVars.text2.font} className={sharedVars.text2.textClassName} outline={sharedVars.text2.outline} outlineColor={sharedVars.text2.outlineColor} bold={sharedVars.text2.bold} italic={sharedVars.text2.italic} underline={sharedVars.text2.underline} isSelected={selectedText === 'text2'} selectedText={'text2'} setSelectedText={setSelectedText} sharedVar={sharedVar} setTextMousePosition={setTextMousePosition}/>
    </div>
  )
}
